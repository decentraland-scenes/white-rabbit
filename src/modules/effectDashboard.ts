...
class EffectUISection extends Entity{
    ...
    addButton(_pos:Vector3, _scale:number, _type:ButtonType, callback:NoArgCallBack) {
...
class EffectDashboard {
    ...
    constructor(_transform:TranformConstructorArgs){
        ...
        this.effectUIRoot.addComponent(new Transform({
        ...
        this.dashboardMesh.addComponent(new Transform({
...
let dashboard = new EffectDashboard({
    position:new Vector3(scene.venueCenter.x - 13, scene.venueCenter.y + 1, scene.venueCenter.z),
